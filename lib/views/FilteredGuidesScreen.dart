...
class FilteredGuidesScreen extends StatefulWidget {
  NearbyDoctorsClass nearbyDoctorsClassFilter;

  FilteredGuidesScreen(this.nearbyDoctorsClassFilter);
  @override
...
class _FilteredGuidesScreen extends State<FilteredGuidesScreen> {
  NearbyDoctorsClass? _nearbyDoctorsClassfilter;
  ...
  void initState() {
    ...
    setState(() {
      _nearbyDoctorsClassfilter = widget.nearbyDoctorsClassFilter;
      list2.addAll(_nearbyDoctorsClassfilter!.data!.nearbyData!);
      list2.removeWhere((element) => element.id == currentId);
      nextUrl = _nearbyDoctorsClassfilter!.data!.nextPageUrl!;
    });
  }
