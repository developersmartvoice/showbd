class Call_All_Api {
  ...
  Call_All_Api({this.status, this.msg, this.data});

  Call_All_Api.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    msg = json['msg'];
...
class Data {
  ...
  Data({this.banner, this.speciality, this.appointment});
...
class Speciality {
  ...
  Speciality({this.id, this.name, this.icon});
